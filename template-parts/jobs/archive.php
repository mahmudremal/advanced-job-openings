					...
					<div class="row">
						<div class="col-sm-12 col-lg-6">
							<div class="candidate_job_alart_btn">
								<h4 class="fz20 mb15"><?php echo esc_html( sprintf( __( '%s Jobs Found', 'domain' ), number_format_i18n( $wp_query->post_count, 0 ) ) ); ?></h4>
								<?php if( $jobAlert ) : ?>
						...
						<div class="col-lg-12">
							<div class="mbp_pagination">
										<?php
											...
											// 	'screen_reader_text' => __( 'Jobs navigation', 'domain' )
											// ] );
											$allowed_tags = [
												'span' => [
													'class' => []
