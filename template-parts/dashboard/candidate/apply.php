  ...
  <form class="row col-12" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="col-lg-12">
      <div class="candidate_resume_select">
        <label for="fwp-apply-job-cv"><?php esc_html_e( 'Select Your CV', 'domain' ); ?></label><br>
    ...
    <div class="col-lg-12">
      <div class="my_resume_textarea mt20">
          <div class="form-group">
            <label for="fwp-apply-job-text"><?php esc_html_e( 'Cover Letter', 'domain' ); ?></label>
    ...
    <div class="col-lg-4">
      <div class="my_profile_input">
        <button type="submit" class="btn btn-lg btn-thm"><?php esc_html_e( 'Send Application', 'domain' ); ?></button>
      </div>
    </div>
  </form>
<?php else: ?>
          ...
          <div class="details">
            ...
            <ul class="view_edit_delete_list float-right">
              <li class="list-inline-item"><a href="<?php echo esc_url( site_url( 
                '/dashboard/candidate/apply-' . $apply->ID . '/' ) ); ?>" data-toggle="tooltip" data-placement="top" title="<?php esc_attr_e( 'Edit', 'domain' ); ?>"><span class="flaticon-edit"></span></a></li>
              <li class="list-inline-item"><a class="delete-application-fwp" href="javascript:void(0);" data-id="<?php echo esc_attr( $apply->ID ); ?>" data-name="" data-toggle="tooltip" data-placement="top" title="<?php esc_attr_e( 'Delete', 'domain' ); ?>"><span class="flaticon-rubbish-bin"></span></a></li>
            </ul>
        </div>
      </div>
    </div>
