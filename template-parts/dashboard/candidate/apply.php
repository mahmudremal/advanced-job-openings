          ...
          <div class="details">
            ...
            <ul class="view_edit_delete_list float-right">
              <li class="list-inline-item"><a href="<?php echo esc_url( site_url( 
                '/dashboard/candidate/apply-' . $apply->ID . '/' ) ); ?>" data-toggle="tooltip" data-placement="top" title="<?php esc_attr_e( 'Edit', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ); ?>"><span class="flaticon-edit"></span></a></li>
