                ...
                <tr>
                  ...
                  <td>
                    <ul class="view_edit_delete_list">
                      ...
                      <li class="list-inline-item"><a href="<?php echo esc_url( admin_url( 'admin-post.php?action=fwp-company-delete-job-action&job=' . $jobInfo[ 'post' ]->ID . '&fwp-company-delete-job-action=' . wp_create_nonce( 'fwp-company-delete-job-action-' . $jobInfo[ 'post' ]->ID ) ) ); ?>" data-toggle="tooltip" data-placement="bottom" title="Delete"><span class="flaticon-rubbish-bin"></span></a></li>
                    </ul>
                  </td>
                </tr>
              <?php endforeach; ?>
