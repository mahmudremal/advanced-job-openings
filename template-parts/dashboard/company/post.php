            ...
            <tbody>
              ...
              if ( $fwp_job_vanues_group ) :
                foreach ( $fwp_job_vanues_group as $field ) {
                  $field = [
                    'JobDate' => isset( $field[ 'JobDate' ] ) ? $field[ 'JobDate' ] : '',
                    'JobLocation' => isset( $field[ 'JobLocation' ] ) ? $field[ 'JobLocation' ] : '',
                    'JobRequirments' => isset( $field[ 'JobRequirments' ] ) ? $field[ 'JobRequirments' ] : '',
                  ];
                  if( empty( $field[ 'JobDate' ] ) ) {continue;}
                  ?>
                  <tr class="">
                    <td class="job-row">
                      <input class="form-control jobvanuedate" type="date" placeholder="<?php esc_attr_e( 'Date', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ); ?>" title="<?php esc_attr_e( 'Date', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ); ?>" name="JobDate[]" value="<?php echo esc_attr( $field['JobDate'] ); ?>" />
                      ...
                      <a class="btn btn-thm mt-2 remove-row" href="#1"><?php esc_html_e( 'Remove', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ); ?></a>
                    </td>
                  </tr>
                  <?php
                }
