					...
					<div class="row">
						<div class="col-lg-12">
							<div class="candidate_about_info style2">
								<h4 class="fz20 mb30"><?php esc_html_e( get_fwp_option( 'company_about_txt', 'About Company' ), FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ); ?></h4>
						...
						<div class="col-lg-12">
							<div class="job_shareing">
								<div class="candidate_social_widget bgc-fa">
									<ul>
										<li><?php esc_html_e( get_fwp_option( 'share_this_company_txt', 'Share this Company' ), FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ); ?>:</li>
										<?php
						...
						<?php if( is_FwpActive( 'company-openposition' ) ) : ?>
							<div class="col-lg-12">
								<div class="my_resume_eduarea">
									<h4 class="title mb30"><?php esc_html_e( get_fwp_option( 'company_open_position_txt', 'Open Position' ), FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ); ?></h4>
								</div>
							</div>
						...
						<?php if( is_FwpActive( 'company-contactmail' ) ) : ?>
							...
							<div class="candidate_contact_form bgc-fa">
								...
								<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
									<input type="hidden" name="action" value="fwp-contact-company-form-action">
									<input type="hidden" name="fwp-contact-company-form[id]" value="<?php echo esc_attr( isset( $companyInfo[ 'meta' ][ 'company' ][ 'authorizeid' ] ) ? $companyInfo[ 'meta' ][ 'company' ][ 'authorizeid' ] : '' ); ?>">
									<input type="hidden" name="fwp-contact-company-form[to]" value="<?php echo esc_attr( isset( $companyInfo[ 'meta' ][ 'company' ][ 'email' ] ) ? $companyInfo[ 'meta' ][ 'company' ][ 'email' ] : '' ); ?>">
									<?php wp_nonce_field( 'fwp-contact-company-form-action', 'fwp-contact-company-form-action', true, true ); ?>
