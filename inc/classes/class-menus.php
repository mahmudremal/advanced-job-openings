...
class Menus {
    ...
    // get_fwp_option( 'key', 'default' )
		...
		$args['text'] = [
			...
			'fields'				=> [
				...
				[
					...
					'type'			=> 'text',
					'default'		=> __( 'Confirm delete?', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
				...
				[
					...
					'type'			=> 'text',
					'default'	=> __( 'Application has been created sucessfully.', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
				...
				[
					...
					'type'			=> 'text',
					'default'	=> __( 'Application has been Updated.', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
				...
				[
					'id' 			=> 'candidate_job_delete_confirm_txt',
					'label'			=> __( 'Confirmation delete job' , FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
					'description'	=> __( 'Text on job delete confirmation will be replace with it.', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
					'type'			=> 'text',
					'default'		=> __( 'Confirm delete?', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
					'placeholder'	=> __( 'Are you sure to delete? Can\'t be undo.', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN )
				],
		...
		$args['message'] = [
			...
			'fields'				=> [
				[
					...
					'type'			=> 'text',
					'default'	=> __( 'Profile Updated successfully', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
				...
				[
					...
					'type'			=> 'text',
					'default'	=> __( 'Successfully created Job', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
				...
				[
					...
					'type'			=> 'text',
					'default'	=> __( 'Successfully Updated Job', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
				...
				[
					...
					'type'			=> 'text',
					'default'	=> __( 'Is autometically approved', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
				...
				[
					...
					'type'			=> 'text',
					'default'	=> __( 'Is pending for approval', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
		...
		$args['shortcodes'] = [
			'title'					=> __( 'Shortcodes', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
			'description'			=> __( 'Default settings on shortcodes globally. If you change anything here, then this changes will applied on every where activate those shortcodes. If you disable any shortcodes, then those shortcodes won\'t function these.', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
			'fields'				=> [
				[
					'id' 			=> 'shortcodes-grid',
					'label'			=> __( 'Jobs grid', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
					'description'	=> sprintf( __( 'Enable main shortcode Jobs grid shortcode. %s. Jobs grid shortcode basically call newly posted jobs that are public and not filled.', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ), '<code>[jobs_grid]</code>' ),
					'type'			=> 'checkbox',
					'default'		=> true
				],
				[
					'id' 			=> 'shortcodes-grid-error',
					'label'			=> __( 'Jobs grid Error', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
					'description'	=> __( 'Enable Jobs grid shortcodes error image if nothing found to display. By default it\'ll show a Frawn cartoon image.', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
					'type'			=> 'checkbox',
					'default'		=> true
				],
				[
					'id' 			=> 'shortcodes-featured',
					'label'			=> __( 'Featured Jobs', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
					'description'	=> sprintf( __( 'Enable featured jobs shortcode. %s', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ), '<code>[ajo-featured type="list" limit="6" order="DESC" hideInactive=true]</code>' ),
					'type'			=> 'checkbox',
					'default'		=> true
				],
				[
					'id' 			=> 'shortcodes-featured-error',
					'label'			=> __( 'Jobs Featured Error', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
					'description'	=> __( 'Enable Jobs featured shortcodes error image if nothing found to display. By default it\'ll show a Frawn cartoon image.', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
					'type'			=> 'checkbox',
					'default'		=> true
				],
				[
					'id' 			=> 'shortcodes-latest',
					'label'			=> __( 'latest Jobs', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
					'description'	=> sprintf( __( 'Enable latest jobs shortcode. %s . Order by descanding by default.', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ), '<code>[ajo-latest type="list" limit="6" hideInactive=true]</code>' ),
					'type'			=> 'checkbox',
					'default'		=> true
				],
				[
					'id' 			=> 'shortcodes-latest-error',
					'label'			=> __( 'Jobs latest Error', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
					'description'	=> __( 'Enable Jobs latest shortcodes error image if nothing found to display. By default it\'ll show a Frawn cartoon image.', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
					'type'			=> 'checkbox',
					'default'		=> true
				],
				[
					'id' 			=> 'shortcodes-list',
					'label'			=> __( 'Jobs List', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
					'description'	=> sprintf( __( 'Enable List jobs shortcode. %s. You can specificly identify which jobs should be visible and which jobs are not by include and exclude attribute. Include and exclude are job ID and are comma separated.', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ), '<code>[ajo-list type="list" limit="6" order="DESC" hideInactive=true include=false exclude=false]</code>' ),
					'type'			=> 'checkbox',
					'default'		=> true
				],
				[
					'id' 			=> 'shortcodes-list-error',
					'label'			=> __( 'Jobs list Error', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
					'description'	=> __( 'Enable Jobs list shortcodes error image if nothing found to display. By default it\'ll show a Frawn cartoon image.', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ),
					'type'			=> 'checkbox',
					'default'		=> true
				],
			]
