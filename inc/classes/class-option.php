...
class Option {
  ...
  private $file;
	...
	public function __construct( $plugin_name = 'advanced-job-openings', $plugin_slug = 'advanced-job-openings', $file = false ){
    if( ! $file ) {$file = __FILE__;}
		$this->file = $file;
		$this->plugin_slug = $plugin_slug;
		$this->plugin_name = $plugin_name;
		$this->textdomain = 'fwp-ajo'; // str_replace('_', '-', $plugin_slug);
	...
	public function add_menu_item() {
		$page = add_options_page( __( 'Job Opening Setup Page', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ), __( 'Job Opening', FUTUREWORDPRESS_PROJECT_TEXT_DOMAIN ), 'manage_options' , $this->plugin_slug,  array( $this, 'settings_page' ) );
	}
	...
	?>
	  <div class="wrap" id="<?php echo $this->plugin_slug; ?>">
	  	<h2><?php _e('Job Opening customization page.', $this->textdomain); ?></h2>
	  	<p><?php _e('Your setting panel from where you can control job opening and customizations.', $this->textdomain); ?></p>
