 ...
 * @return void
 */
function FUTUREWORDPRESS_PROJECT_posted_on() {
 ...
 * @return void
 */
function FUTUREWORDPRESS_PROJECT_posted_by() {
	$byline = sprintf(
 ...
 * @return bool|string
 */
function FUTUREWORDPRESS_PROJECT_the_excerpt( $trim_character_count = 0 ) {
	$post_ID = get_the_ID();
 ...
 */
function FUTUREWORDPRESS_PROJECT_excerpt_more( $more = '' ) {
 ...
 */
function FUTUREWORDPRESS_PROJECT_the_post_pagination( $current_page_no, $posts_per_page, $article_query, $first_page_url, $last_page_url, bool $is_query_param_structure = true ) {
 ...
 */
function FUTUREWORDPRESS_PROJECT_is_uploaded_via_wp_admin( $gravatar_url ) {
 ...
 * @return bool
 */
function FUTUREWORDPRESS_PROJECT_has_gravatar( $user_email ) {

	$gravatar_url = get_avatar_url( $user_email );

	if ( FUTUREWORDPRESS_PROJECT_is_uploaded_via_wp_admin( $gravatar_url ) ) {
		return true;
	}
